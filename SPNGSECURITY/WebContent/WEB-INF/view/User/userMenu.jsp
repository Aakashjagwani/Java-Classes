<div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
      ...
      <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          <li class=" nav-item"><a href="DashBoard.jsp"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Dashboard</span><span class="tag tag tag-primary tag-pill float-xs-right mr-2">5</span></a>
           <!--  <ul class="menu-content">
              <li class="active"><a href="dashboard-ecommerce.html" data-i18n="nav.dash.ecommerce" class="menu-item">eCommerce</a>
              </li>
            ...
            <li class=" nav-item"><a href="#"><i class="icon-folder2"></i><span data-i18n="nav.templates.main" class="menu-title">Folder</span></a>
            <ul class="menu-content">
              <li><a href="InsertFolder.htm" data-i18n="nav.templates.vert.main"><i class="icon-folder-plus"></i>Create Folder</a>
              </li>
              <li><a href="ViewFolder.htm" data-i18n="nav.templates.horz.main"><i class="icon-folder-open"></i>View Folder</a>
               </li>
            </ul>
          </li>
           <li class=" nav-item"><a href="#"><i class="icon-file-text"></i><span data-i18n="nav.templates.main" class="menu-title">File</span></a>
            <ul class="menu-content">
              <li><a href="InsertFile.htm" data-i18n="nav.templates.vert.main"><i class="icon-folder-upload"></i>Upload File</a>
              </li>
              <li><a href="ViewFile.htm" data-i18n="nav.templates.horz.main" class="menu-item"><i class="icon-folder-download"></i>View File</a>
               </li>
            </ul>
          </li>
            <li class=" nav-item"><a href="#"><i class="icon-bubbles3"></i><span data-i18n="nav.templates.main" class="menu-title">Feedback</span></a>
            <ul class="menu-content">
              <li><a href="InsertFeedback.htm" data-i18n="nav.templates.vert.main" class="menu-item">Add Feedback</a>
              </li>
              </ul>
          </li>
            <li class=" nav-item"><a href="#"><i class="icon-clipboard2"></i><span data-i18n="nav.templates.main" class="menu-title">ComplainBox</span></a>
            <ul class="menu-content">
              <li><a href="InsertComplain.htm" data-i18n="nav.templates.vert.main" class="menu-item">Post Complain</a>
              </li>
              <li><a href="ViewAdminReplay.htm" data-i18n="nav.templates.horz.main" class="menu-item">View Complain</a>
              </li>
            </ul>
          </li>
 <!--        <li class=" navigation-header"><span data-i18n="nav.category.layouts">Layouts</span><i data-toggle="tooltip" data-placement="right" data-original-title="Layouts" class="icon-ellipsis icon-ellipsis"></i>
          ...
          <li class=" nav-item"><a href="#"><i class="icon-panorama_vertical"></i><span data-i18n="nav.vertical_nav.main" class="menu-title">Vertical Nav</span></a>
            <ul class="menu-content">
              <li><a href="#" data-i18n="nav.vertical_nav.vertical_navigation_types.main" class="menu-item">Navigation Types</a>
                <ul class="menu-content">
                  <li><a href="../vertical-menu-template" data-i18n="nav.vertical_nav.vertical_navigation_types.vertical_menu" class="menu-item">Vertical Menu</a>
                  </li>
                  <li><a href="../vertical-multi-level-menu-template" data-i18n="nav.vertical_nav.vertical_navigation_types.vertical_mmenu" class="menu-item">Vertical MMenu</a>
                  </li>
                  <li><a href="../vertical-overlay-menu-template" data-i18n="nav.vertical_nav.vertical_navigation_types.vertical_overlay" class="menu-item">Vertical Overlay</a>
                  </li>
                  <li><a href="../vertical-compact-menu-template" data-i18n="nav.vertical_nav.vertical_navigation_types.vertical_compact" class="menu-item">Vertical Compact</a>
                  </li>
                  <li><a href="../vertical-content-menu-template" data-i18n="nav.vertical_nav.vertical_navigation_types.vertical_content" class="menu-item">Vertical Content</a>
                  </li>
                </ul>
              </li>
          ...
          <li class=" nav-item"><a href="#"><i class="icon-bulb"></i><span data-i18n="nav.starter_kit.main" class="menu-title">Starter kit</span></a>
            <ul class="menu-content">
              <li><a href="../../../starter-kit/LTR/vertical-menu-template/layout-1-column.html" data-i18n="nav.starter_kit.1_column" class="menu-item">1 column</a>
              </li>
              <li><a href="../../../starter-kit/LTR/vertical-menu-template/layout-2-columns.html" data-i18n="nav.starter_kit.2_columns" class="menu-item">2 columns</a>
              </li>
              <li><a href="#" data-i18n="nav.starter_kit.3_columns.main" class="menu-item">Content Sidebar</a>
                <ul class="menu-content">
                  <li><a href="../../../starter-kit/LTR/vertical-menu-template/layout-content-left-sidebar.html" data-i18n="nav.starter_kit.3_columns.3_columns_left_sidebar" class="menu-item">Left sidebar</a>
                  </li>
                  <li><a href="../../../starter-kit/LTR/vertical-menu-template/layout-content-left-sticky-sidebar.html" data-i18n="nav.starter_kit.3_columns.3_columns_left_sticky_sidebar" class="menu-item">Left sticky sidebar</a>
                  </li>
                  <li><a href="../../../starter-kit/LTR/vertical-menu-template/layout-content-right-sidebar.html" data-i18n="nav.starter_kit.3_columns.3_columns_right_sidebar" class="menu-item">Right sidebar</a>
                  </li>
                  <li><a href="../../../starter-kit/LTR/vertical-menu-template/layout-content-right-sticky-sidebar.html" data-i18n="nav.starter_kit.3_columns.3_columns_right_sticky_sidebar" class="menu-item">Right sticky sidebar</a>
                  </li>
                </ul>
              </li>
              <li><a href="#" data-i18n="nav.starter_kit.3_columns_detached.main" class="menu-item">Content Det. Sidebar</a>
                <ul class="menu-content">
                  <li><a href="../../../starter-kit/LTR/vertical-menu-template/layout-content-detached-left-sidebar.html" data-i18n="nav.starter_kit.3_columns_detached.3_columns_detached_left_sidebar" class="menu-item">Detached left sidebar</a>
                  </li>
                  <li><a href="../../../starter-kit/LTR/vertical-menu-template/layout-content-detached-left-sticky-sidebar.html" data-i18n="nav.starter_kit.3_columns_detached.3_columns_detached_sticky_left_sidebar" class="menu-item">Detached sticky left sidebar</a>
                  </li>
                  <li><a href="../../../starter-kit/LTR/vertical-menu-template/layout-content-detached-right-sidebar.html" data-i18n="nav.starter_kit.3_columns_detached.3_columns_detached_right_sidebar" class="menu-item">Detached right sidebar</a>
                  </li>
                  <li><a href="../../../starter-kit/LTR/vertical-menu-template/layout-content-detached-right-sticky-sidebar.html" data-i18n="nav.starter_kit.3_columns_detached.3_columns_detached_sticky_right_sidebar" class="menu-item">Detached sticky right sidebar</a>
                  </li>
                </ul>
              </li>
              <li class="navigation-divider"></li>
              <li><a href="../../../starter-kit/LTR/vertical-menu-template/layout-fixed-navbar.html" data-i18n="nav.starter_kit.fixed_navbar" class="menu-item">Fixed navbar</a>
              </li>
              <li><a href="../../../starter-kit/LTR/vertical-menu-template/layout-fixed-navigation.html" data-i18n="nav.starter_kit.fixed_navigation" class="menu-item">Fixed navigation</a>
              </li>
              <li><a href="../../../starter-kit/LTR/vertical-menu-template/layout-fixed-navbar-navigation.html" data-i18n="nav.starter_kit.fixed_navbar_navigation" class="menu-item">Fixed navbar &amp; navigation</a>
              </li>
              <li><a href="../../../starter-kit/LTR/vertical-menu-template/layout-fixed-navbar-footer.html" data-i18n="nav.starter_kit.fixed_navbar_footer" class="menu-item">Fixed navbar &amp; footer</a>
              </li>
              <li class="navigation-divider"></li>
              <li><a href="../../../starter-kit/LTR/vertical-menu-template/layout-fixed.html" data-i18n="nav.starter_kit.fixed_layout" class="menu-item">Fixed layout</a>
              </li>
              <li><a href="../../../starter-kit/LTR/vertical-menu-template/layout-boxed.html" data-i18n="nav.starter_kit.boxed_layout" class="menu-item">Boxed layout</a>
              </li>
              <li><a href="../../../starter-kit/LTR/vertical-menu-template/layout-static.html" data-i18n="nav.starter_kit.static_layout" class="menu-item">Static layout</a>
              </li>
              <li class="navigation-divider"></li>
              <li><a href="../../../starter-kit/LTR/vertical-menu-template/layout-light.html" data-i18n="nav.starter_kit.light_layout" class="menu-item">Light layout</a>
              </li>
              <li><a href="../../../starter-kit/LTR/vertical-menu-template/layout-dark.html" data-i18n="nav.starter_kit.dark_layout" class="menu-item">Dark layout</a>
              </li>
              <li><a href="../../../starter-kit/LTR/vertical-menu-template/layout-semi-dark.html" data-i18n="nav.starter_kit.semi_dark_layout" class="menu-item">Semi dark layout</a>
              </li>
            </ul>
          </li>
          <li class=" nav-item"><a href="changelog.html"><i class="icon-copy"></i><span data-i18n="nav.changelog.main" class="menu-title">Changelog</span><span class="tag tag tag-pill tag-danger float-xs-right">1.2</span></a>
          </li>
          ...
          <li class=" nav-item"><a href="#"><i class="icon-whatshot"></i><span data-i18n="nav.advance_cards.main" class="menu-title">Advance Cards</span></a>
            <ul class="menu-content">
              ...
              <li><a href="card-weather.html" data-i18n="nav.cards.card_weather" class="menu-item">Weather</a>
              </li>
              <li><a href="card-charts.html" data-i18n="nav.cards.card_charts" class="menu-item">Charts</a>
              </li>
              <li><a href="card-interactive.html" data-i18n="nav.cards.card_interactive" class="menu-item">Interactive</a>
              </li>
              <li><a href="card-maps.html" data-i18n="nav.cards.card_maps" class="menu-item">Maps</a>
              </li>
              <li><a href="card-social.html" data-i18n="nav.cards.card_social" class="menu-item">Social</a>
              </li>
              <li><a href="card-ecommerce.html" data-i18n="nav.cards.card_ecommerce" class="menu-item">E-Commerce</a>
              </li>
            </ul>
          </li>
          ...
          <li class=" nav-item"><a href="https://pixinvent.com/bootstrap-admin-template/robust/documentation"><i class="icon-document-text"></i><span data-i18n="nav.support_documentation.main" class="menu-title">Documentation</span></a>
          </li>  -->
        </ul>
      </div>  
      <!-- /main menu content-->
