        ...
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          <li class=" nav-item"><a href="DashBoard.jsp"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Dashboard</span><span class="tag tag tag-primary tag-pill float-xs-right mr-2">5</span></a>
           <!--  <ul class="menu-content">
            ...
            <li class=" nav-item"><a href=""><i class="icon-folder2"></i><span data-i18n="nav.templates.main" class="menu-title">Manage Folder</span></a>
            <ul class="menu-content">
              <li><a href="ViewAdminFolder.htm" data-i18n="nav.templates.horz.main" class="menu-item">View Folder</a>
               </li>
            </ul>
          </li>
           <li class=" nav-item"><a href="#"><i class="icon-file-text"></i><span data-i18n="nav.templates.main" class="menu-title">Manage File</span></a>
            <ul class="menu-content">
              <li><a href="ViewAdminFile.htm" data-i18n="nav.templates.horz.main" class="menu-item">View File</a>
               </li>
            </ul>
          </li>
            <li class=" nav-item"><a href=""><i class="icon-bubbles3"></i><span data-i18n="nav.templates.main" class="menu-title">Feedback</span></a>
            <ul class="menu-content">
              <li><a href="ViewFeedback.htm" data-i18n="nav.templates.horz.main" class="menu-item">View Feedback</a>
              </li>
            </ul>
          </li>
            <li class=" nav-item"><a href="#"><i class="icon-clipboard2"></i><span data-i18n="nav.templates.main" class="menu-title">Manage ComplainBox</span></a>
            <ul class="menu-content">
              <li><a href="ViewComplain.htm" data-i18n="nav.templates.horz.main" class="menu-item">View Complain</a>
              </li>
            </ul>
          </li>
           <li class=" nav-item"><a href="#"><i class="icon-users2"></i><span data-i18n="nav.templates.main" class="menu-title">Manage User</span></a>
            <ul class="menu-content">
              <li><a href="ViewUser.htm" data-i18n="nav.templates.horz.main" class="menu-item">View User Registration</a>
              </li>
            </ul>
          </li>
