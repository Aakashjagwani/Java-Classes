				...
				<div class="b-b mb-10">
					<div class="row">
						<div class="col-sm-6 col-xs-12">
							<h1 class="h3 m-0">Feedback Manager</h1>
						</div>
					</div>
				</div>
								...
								<table id="searchTextResults" data-filter="#filter" data-page-size="5" class="footable table table-custom">
									...
									<tbody>
										...
										<tr>
											...
											<td><a href="editFeedback.html?id=${i.feedbackId}">Edit</a></td>
											<td><a href="deleteFeedback.html?id=${i.feedbackId}">Delete</a></td>
										</tr>
										</x:forEach>
									</tbody>
