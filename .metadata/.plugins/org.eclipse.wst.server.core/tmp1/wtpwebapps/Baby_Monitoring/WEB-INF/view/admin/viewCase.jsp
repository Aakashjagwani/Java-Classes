				...
				<div class="b-b mb-10">
					<div class="row">
						<div class="col-sm-6 col-xs-12">
							<h1 class="h3 m-0">Case Subscription plans</h1>
						</div>
					</div>
				</div>
								...
								<table id="searchTextResults" data-filter="#filter" data-page-size="5" class="footable table table-custom">
									...
									<tbody>
										...
										<tr>
											...
											<td>${i.fileName}</td>
											<td>${i.filePath}</td>
											<td><a href="editCase.html?id=${i.caseId}">Edit</a></td>
											<td><a href="deleteCase.html?id=${i.caseId}">Delete</a></td>
										</tr>
										</x:forEach>
									</tbody>
