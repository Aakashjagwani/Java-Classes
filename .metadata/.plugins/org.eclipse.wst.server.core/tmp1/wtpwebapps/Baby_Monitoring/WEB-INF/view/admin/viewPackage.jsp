				...
				<div class="b-b mb-10">
					<div class="row">
						<div class="col-sm-6 col-xs-12">
							<h1 class="h3 m-0">Package Subscription plans</h1>
						</div>
					</div>
				</div>
							...
							<div class="boxs-body">
								...
								<table id="searchTextResults" data-filter="#filter" data-page-size="5" class="footable table table-custom">
									...
									<tbody>
										...
										<tr>
											<td>${i.packageId}</td>
											<td>${i.packageTitle}</td>
											<td>${i.packageDescription}</td>
											<td>${i.packageDuration}</td>
											<td>${i.packageAmount}</td>
											<td><a href="editPackage.html?id=${i.packageId}">Edit</a></td>
											<td><a href="deletePackage.html?id=${i.packageId}">Delete</a></td>
										</tr>
										</x:forEach>
									</tbody>
