			...
			<div class="page page-forms-validate">
				...
				<div class="row">
					<div class="col-md-12">
						<section class="boxs">
							<div class="boxs-body">
								<f:form class="form-horizontal" action="newFeedback.html" modelAttribute="data" method="GET">
									<div class="form-group">
										<label class="col-sm-3 control-label">Feedback Description</label>
										<div class="col-sm-9">
											<f:input type="text" class="form-control" path="feedbackDescription" placeholder="Enter description of feedback" data-parsley-trigger="change" required="required"/>
										</div>
									</div>
