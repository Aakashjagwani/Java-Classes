...
public class news_controller {
	...
	public ResponseEntity<registration> getNewsPaperById(@RequestParam("id") String id) {
		registration newspaper = newsService.getNewsPaperById(Integer.parseInt(id));
	...
	public ResponseEntity<Void> deleteNewsPaper(@RequestParam("id") String id) {
		newsService.deleteNewsPaper(Integer.parseInt(id));
